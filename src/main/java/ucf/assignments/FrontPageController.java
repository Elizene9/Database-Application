...
public class FrontPageController
{
    ...
    // FXML Controls to display inventory items
    @FXML
    ...
    // Sorts list by value and displays the sorted list
    ...
    // Sorts list by name and displays the sorted list
    @SuppressWarnings("DuplicatedCode")
    ...
    // Sorts list by serial number and displays the sorted list
    @SuppressWarnings("DuplicatedCode")
    ...
    // Saves file to ANY directory on the device running the application
    ...
    // Loads inventory list from .txt file and allows it to be displayed
    ...
    // Can open any file on user's device (if user wants to see files storing inventory)
    ...
    // Dynamic search to check if item exists in inventory
    public void PopulateSearch()
    {
        ...
        for (int i = 0; i < Inventory.allItems.size(); i++)
        {
            ...
            if (Inventory.allItems.get(i).name.toLowerCase().contains(search.toLowerCase()))
            {
            ...
            if (Inventory.allItems.get(i).Serial.toLowerCase().contains(search.toLowerCase()))
            {
