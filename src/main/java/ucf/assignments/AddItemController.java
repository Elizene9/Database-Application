...
// This class adds a new item to inventory and checks for valid data entry
public class AddItemController
{
    ...
    boolean serialCheck = true, nameCheck, valueCheck, serialEntry = false,
            nameEntry = false, valueEntry = false;
